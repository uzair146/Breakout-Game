...
Overview
This is a console-based Breakout-style arcade game implemented in x86 Assembly Language as a semester project for Computer Organization and Assembly Language (COAL). 
The game runs in DOS mode and features classic gameplay where players control a paddle to bounce a ball and break bricks. It demonstrates low-level programming concepts 
such as memory management, interrupts for keyboard input, timer delays, sound generation via PC speaker, and text-mode graphics.
...
Assemble the Code:
Assemble the main file: nasm main.asm -f bin -o breakout.com 
